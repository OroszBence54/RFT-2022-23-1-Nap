...
class FormValidator {
    ...
    public function pattern($name){
        ...
        if($name == 'array'){
            ...
            if(!is_array($this->value)){
                $this->errors[] = $this->name.' nevű mező nem érvényes.';
            }
    ...
    public function required(){
        ...
        if((isset($this->file) && $this->file['error'] == 4) || ($this->value == '' || $this->value == null)){
            $this->errors[] = $this->name.' nevű mező kitöltése kötelező.';
        }
        return $this;
    ...
    public function min($length){
        ...
        if(is_string($this->value)){
            ...
            if(strlen($this->value) < $length){
                $this->errors[] = $this->name.' nevű mező értéke kisebb mint a megengedett.';
            }
    ...
    public function max($length){
        ...
        if(is_string($this->value)){
            ...
            if(strlen($this->value) > $length){
                $this->errors[] = $this->name.' nevű mező értéke nagyobb mint a megengedett.';
            }
    ...
    public function equal($value){
        ...
        if($this->value != $value){
            $this->errors[] = $this->name.' nevű mező nem egyezik a másikkal.';
        }
        return $this;
